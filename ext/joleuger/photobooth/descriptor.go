...
// Descriptor is the photobooth extension's entry in ext.Bundled.
type descriptor struct{}

func (descriptor) Key() string { return "joleuger/photobooth" }
...
func (descriptor) Dependencies() []extdep.Dependency { return Dependencies }
